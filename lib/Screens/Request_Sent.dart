...
import 'package:flutter_application_2/Screens/Appoinments.dart';
import 'package:flutter_application_2/Screens/customerHomescreen.dart';
                      ...
                      children: [
                        Column(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            ...
                            Text('Crown Canvas Saloon',style: GoogleFonts.poppins(fontSize: 10),),
                          ],
                        ),
                        SizedBox(width: 20.h,),
                        Column(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            ...
                            Text('Hair Styling Make Over',style: GoogleFonts.poppins(fontSize: 10),),
                          ],
                        ),
                      ],
                    ),
                      ...
                      children: [
                        Column(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            ...
                            Text('£15.30',style: GoogleFonts.poppins(fontSize: 10),),
                          ],
                        ),
                        SizedBox(width: 20.h,),
                        Column(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            ...
                            Text('£16.10 including taxes',style: GoogleFonts.poppins(fontSize: 10),),
                          ],
                        ),
                      ],
                    ),
                      ...
                      children: [
                        Column(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            ...
                            Text('05:00 PM',style: GoogleFonts.poppins(fontSize: 10),),
                          ],
                        ),
